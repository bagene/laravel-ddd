...
return [
    ...
    'description' => 'Quick HR API is a RESTful API that provides endpoints for managing employees, departments, and positions. It is built with Laravel 8 and uses Laravel Passport for authentication. The API is designed to be consumed by a web application.',
